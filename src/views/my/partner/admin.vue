    ...
    <div class="company-page">
        ...
        <div class="company-settled">
            ...
            <van-form @submit="submit">
                <van-field v-model="state.city" label="您所在的城市:" placeholder="请选择城市" readonly is-link
                ...
                <van-field v-model="state.sex" @click="state.showSex = true" readonly label="您的性别:"
                    placeholder="请选择您的性别" />
                ...
                <van-field v-model="state.introduce" class="field-last" type="textarea" rows="8" label="具体介绍:"

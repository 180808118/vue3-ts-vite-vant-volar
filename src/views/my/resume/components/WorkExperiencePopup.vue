...
<template>
    ...
    <div class="user-item">
        ...
        <div class="work-time-list">
            <van-field v-model="state.startTime" readonly label="" placeholder="请选择"
        ...
        <van-action-sheet v-model:show="state.showStartTime">
            <van-datetime-picker type="date" title="选择年月" :min-date="state.minDate" :max-date="state.maxDate"
                @confirm="startTimeConfirm" @cancel="state.showStartTime = false" />
        </van-action-sheet>
        <van-action-sheet v-model:show="state.showEndTime">
            <van-datetime-picker type="date" title="选择年月" :min-date="state.minDate" :max-date="state.maxDate"
                @confirm="endTimeConfirm" @cancel="state.showEndTime = false" />
        </van-action-sheet>
    </div>
    <div class="user-item">
        <h5>工作描述</h5>
        <van-field v-model="state.workDesc" label="" placeholder="请填写您的工作描述" type="textarea" rows="10" autosize />
    </div>
